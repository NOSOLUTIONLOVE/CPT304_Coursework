...
status: completed
date: 2026-04-21
origin: coursework/docs/brainstorms/2026-04-21-inventory-management-system-workspace-requirements.md
---
...
小组已选定课题，但需要可追溯的本地/仓库内结构，避免缺陷、文献与重构基准在组内口头传递中丢失；同时需对齐 CPT304 对「真缺陷」与「步骤 4 基准」的区分（见 `coursework/docs/brainstorms/2026-04-21-cpt304-prerequisite-work-requirements.md`）。
...
- `coursework/docs/reports/lighthouse-comparative-analysis.md`、`coursework/docs/reports/lighthouse-cpt304-multi-criteria-evaluation.md` — 已知无障碍与性能热点（如 `html` 缺 `lang`、缺 main landmark、Legacy JS 等）；**审计缺陷须基于源码独立论证**，不能仅复述 Lighthouse 条目作为四缺陷的唯一依据。
- `coursework/docs/guides/cpt304-prerequisite-work-playbook.md` — 前置流程对齐。
...
- **模块化：** 与 brainstorm 一致，按 **壳与无障碍 / 表格与 CRUD / 持久化 / 样式 / 质量与基准** 分工；工作区用 `inventory-management-system/docs/module-owners.md` 固化认领。
...
- **Origin document:** [coursework/docs/brainstorms/2026-04-21-inventory-management-system-workspace-requirements.md](coursework/docs/brainstorms/2026-04-21-inventory-management-system-workspace-requirements.md)
- Related: [coursework/docs/brainstorms/2026-04-21-cpt304-prerequisite-work-requirements.md](coursework/docs/brainstorms/2026-04-21-cpt304-prerequisite-work-requirements.md)
